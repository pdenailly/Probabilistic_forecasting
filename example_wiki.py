...
from VAR import VARlassoPredictor
...
train_ds, test_ds, target_dim, freq, prediction_length = data_creation(params, data = "wikipedia")
...
test6 = {'model':'lstmmaf', 'num_cells':40  ,  'lr':1e-3, 'num_cells1':20, 'num_cells2':40}
test7 = {'model':'timegrad', 'num_cells':40  ,  'lr':1e-3, 'num_cells1':20, 'num_cells2':40}
...
for test in list_tests:
    ...
    for rep in range(0, 3):
       ...
       try:  
          ...
          targets, forecasts = metrics_rolling_dataset1(test_ds, predictor, params, test,rep,data)
       except:
